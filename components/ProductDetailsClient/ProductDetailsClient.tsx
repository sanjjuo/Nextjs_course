...
const ProductDetailsClient = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center relative">
      <Link
        href="/products"
        className="absolute left-0 top-0 capitalize text-lg underline hover:text-blue-600"
      >
        {" "}
        back
      </Link>
      ...
      <div className="mt-5 w-[500px]">
        ...
        <div className="mt-5">
          <h6 className="text-3xl">${productDetails.price}</h6>
